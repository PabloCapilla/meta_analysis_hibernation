...
```{r}
#saveRDS(object = model_SMD, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/01a_metamodel_hibernation_OS.RDS')
model_SMD <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/01a_metamodel_hibernation_OS.RDS')
summary(model_SMD)
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/01a_overall_plot_hibernation_OS.png", 
       plot = overall_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_thermoregulation, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/02a_metareg_thermoregulation_hibernation_OS.RDS')
model_SMD_thermoregulation <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/02a_metareg_thermoregulation_hibernation_OS.RDS')
summary(model_SMD_thermoregulation)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/02a_thermoregulation_plot_OS.png", 
       plot = thermo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_endo, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/03a_metareg_hibernation_endo_OS.RDS')
model_SMD_endo <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/03a_metareg_hibernation_endo_OS.RDS')
summary(model_SMD_endo)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/03a_endo_plot_OS.png", 
       plot = endo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_ecto, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/04a_metareg_ecto_hibernation_OS.RDS')
model_SMD_ecto <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/04a_metareg_ecto_hibernation_OS.RDS')
summary(model_SMD_ecto)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/04a_ecto_plot_OS.png", 
       plot = ecto_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
