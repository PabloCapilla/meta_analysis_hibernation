...
```{r}
#saveRDS(object = model_SMD_arousal, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/01b_metamodel_arousal_IM.RDS')
model_SMD_arousal <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/01b_metamodel_arousal_IM.RDS')
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/02_arousal/01b_overall_plot_arousal_IM.png", 
       plot = overall_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_biomarker, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/02z_metareg_biomarker_arousal_IM.RDS')
model_SMD_biomarker <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/02z_metareg_biomarker_arousal_IM.RDS')
summary(model_SMD_biomarker)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/02_arousal//02z_biomarker_IM.png", 
       plot = biomarker_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_arousal_thermoregulation, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/02b_metareg_thermoregulation_arousal_IM.RDS')
model_SMD_arousal_thermoregulation <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/02b_metareg_thermoregulation_arousal_IM.RDS')
summary(model_SMD_arousal_thermoregulation)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/02_arousal/02b_thermoregulation_plot_IM.png", 
       plot = thermo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_arousal_endo, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/03b_metareg_hibernation_endo_IM.RDS')
model_SMD_arousal_endo <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/03b_metareg_hibernation_endo_IM.RDS')
summary(model_SMD_arousal_endo)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/02_arousal/03b_endo_plot_IM.png", 
       plot = endo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_arousal_ecto, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/04b_metareg_ecto_hibernation_IM.RDS')
model_SMD_arousal_ecto <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/02_arousal/04b_metareg_ecto_hibernation_IM.RDS')
summary(model_SMD_arousal_ecto)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/02_arousal/04b_ecto_plot_IM.png", 
       plot = ecto_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
