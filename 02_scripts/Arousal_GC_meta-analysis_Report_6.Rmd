...
```{r}
saveRDS(object = model_SMD, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/02_arousal/01c_metamodel_hibernation_GC.RDS')
model_SMD <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/02_arousal/01c_metamodel_hibernation_GC.RDS')
summary(model_SMD)
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/02_arousal/01c_overall_plot_hibernation_GC.png", 
       plot = overall_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
saveRDS(object = model_SMD_thermoregulation, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/02_arousal/02c_metareg_thermoregulation_hibernation_GC.RDS')
model_SMD_thermoregulation <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/02_arousal/02c_metareg_thermoregulation_hibernation_GC.RDS')
summary(model_SMD_thermoregulation)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/02_arousal/02c_thermoregulation_plot_GC.png", 
       plot = thermo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
