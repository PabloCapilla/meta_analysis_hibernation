...
```{r}
#saveRDS(object = model_SMD, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/01b_metamodel_hibernation_IM.RDS')
model_SMD <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/01b_metamodel_hibernation_IM.RDS')
summary(model_SMD)
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/01b_overall_plot_hibernation_IM.png", 
       plot = overall_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_thermoregulation, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/02b_metareg_thermoregulation_hibernation_IM.RDS')
model_SMD_thermoregulation <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/02b_metareg_thermoregulation_hibernation_IM.RDS')
summary(model_SMD_thermoregulation)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/02b_thermoregulation_plot_IM.png", 
       plot = thermo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_endo, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/03b_metareg_hibernation_endo_IM.RDS')
model_SMD_endo <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/03b_metareg_hibernation_endo_IM.RDS')
summary(model_SMD_endo)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/03b_endo_plot_IM.png", 
       plot = endo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
...
```{r}
#saveRDS(object = model_SMD_ecto, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/04b_metareg_ecto_hibernation_IM.RDS')
model_SMD_ecto <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/04_models/01_hibernation/04b_metareg_ecto_hibernation_IM.RDS')
summary(model_SMD_ecto)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/03_plots/01_hibernation/04b_ecto_plot_IM.png", 
       plot = ecto_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
