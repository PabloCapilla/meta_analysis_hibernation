...
df_SMD <- data %>%
  ...
  filter(SMDH < 30) # need to report that this outlier was removed
```
...
```{r}
saveRDS(object = model_SMD, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/01g_metamodel_estivation_OS.RDS')
model_SMD <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/01g_metamodel_estivation_OS.RDS')
summary(model_SMD)
...
overall_plot <- orchard_plot(object = model_SMD, 
  ...
  scale_y_continuous(limits = c(-10, 10), breaks = seq(-10,10,5), label = seq(-10,10,5))


ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/03_aestivation/01g_overall_plot_estivation_OS.png", 
       plot = overall_plot, 
       device = "png", 
       height = 120, 
       width = 185, 
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/03_aestivation/01g_overall_plot_estivation_OS.pdf", 
       plot = overall_plot, 
       height = 120, 
       width = 185, 
       units = "mm")
...
saveRDS(object = model_SMD_pb, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/06g_pb_metamodel_estivation_OS.RDS')
model_SMD_pb <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/06g_pb_metamodel_estivation_OS.RDS')
```
...
saveRDS(object = model_SMD_tl, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/07g_timelag_metamodel_estivation_OS.RDS')
model_SMD_tl <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/07g_timelag_metamodel_estivation_OS.RDS')
```
...
```{r}
saveRDS(object = model_SMD_biomarker, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/02g_metareg_biomarker_estivation_OS.RDS')
model_SMD_biomarker <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/03_aestivation/02g_metareg_biomarker_estivation_OS.RDS')
summary(model_SMD_biomarker)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/03_aestivation/02g_biomarker_estivation_OS.png", 
       plot = biomarker_plot, 
       device = "png", 
       height = 120, 
       width = 185, 
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/03_aestivation/02g_biomarker_estivation_OS.pdf", 
       plot = biomarker_plot, 
       height = 120, 
       width = 185, 
       units = "mm")
