...
```{r}
saveRDS(object = model_SMD_thermoregulation, file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/01_hibernation/02c_metareg_thermoregulation_hibernation_GC.RDS')
model_SMD_thermoregulation <- readRDS(file = 'C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/04_models/01_hibernation/02c_metareg_thermoregulation_hibernation_GC.RDS')
summary(model_SMD_thermoregulation)
```
...
ggsave(filename = "C:/Users/pca/Dropbox/PabloCL/2-Work drive/3-Active_projects/8 - Collaborations/Meta-analysis_hibernation/meta_analysis_hibernation/03_plots/01_hibernation/02c_thermoregulation_plot_GC.png", 
       plot = thermo_plot, 
       device = "png", 
       height = 90, 
       width = 150, 
