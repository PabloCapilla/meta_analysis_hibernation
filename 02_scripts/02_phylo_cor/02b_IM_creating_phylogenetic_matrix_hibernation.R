...
##
data <- readRDS(
  "./01_data/processed_RDS_data_files/02_IM_metaanalysis_hibernation_full_data.RDS"
)
head(data)
str(data)
unique(data$Species)
...
saveRDS(
  tree,
  file = "./01_data/processed_RDS_data_files/02_IM_phylogenetic_tree_hibernation.RDS"
)
##
##
...
saveRDS(
  phylo_cor,
  file = "./01_data/processed_RDS_data_files/02_IM_phylogenetic_correlations_hibernation.RDS"
)
