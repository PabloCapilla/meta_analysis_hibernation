...
##
data <- readRDS(
  "./01_data/processed_RDS_data_files/04_OS_metaanalysis_arousal_full_data.RDS"
)
head(data)
str(data)
...
saveRDS(
  tree,
  file = "./01_data/processed_RDS_data_files/04_OS_phylogenetic_tree_arousal.RDS"
)
##
##
...
saveRDS(
  phylo_cor,
  file = "./01_data/processed_RDS_data_files/04_OS_phylogenetic_correlations_arousal.RDS"
)
